...
public:
	...
	//err_ampd is the amplitude error
	double err_ampd;
	//err_phase is the phase error
	double err_phase;
	
	string main_fd_name;
	int creat_main_fd_ctrl;

	Data_process(string vis_namee = "", int indexx = 0, string fd_namee = "", string data_typee = "", string size_sufxx = "", double err_ampdd=0, double err_phasee=0, string main_fd_namee ="",
